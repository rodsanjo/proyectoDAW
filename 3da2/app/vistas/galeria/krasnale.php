<h2 class="titulo_seccion"><img src="<?php echo URL_ROOT ?>recursos/imagenes/Wroclaw_escudo.jpg" width="50px"/>  <?php echo iText('Enanos encontrados en Breslavia', 'frases'); ?>  <img src="<?php echo URL_ROOT ?>recursos/imagenes/Wroclaw_escudo.jpg" width="50px"/></h2>
<center>
    <div class='krasnale'>
    <?php
        $i=0;
