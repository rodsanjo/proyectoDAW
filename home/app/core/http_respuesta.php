...
//			self::set_header_line("Content-Length", (string)mb_strlen(self::$http_body_content, "utf8") ); // Comentamos esta línea porque el nuevo hostinger.es da problemas con utf8 //Hostinger se queda en blanco
